  ...
  return (
    ...
    <h1>All Scorecards</h1>
      {scorecardArray.map(element => {
        ...
        return (
          <div key={element._id} className='table'>
          ...
          <table>
              ...
              <tbody>
                  ...
                  <tr className='single-par'>
                      ...
                      <td className='single-par'>{parTotal = element.course.hole1 + element.course.hole2 + element.course.hole3 + element.course.hole4 + element.course.hole5
